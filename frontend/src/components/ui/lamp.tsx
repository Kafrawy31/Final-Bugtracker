...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 mb-[23rem] items-start justify-center isolate z-0 ">
        <motion.div
        ...
        <div className="absolute inset-auto z-50 h-56 w-[28rem] -translate-y-1/2  bg-black   opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem]  bg-gray-300 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
